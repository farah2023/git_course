...
<div class="profile">
      <?php
         $select = mysqli_query($conn, "SELECT * FROM `marque` WHERE id = '$user_id'") or die('query failed'); // Exécuter une requête SQL pour récupérer les données de l'utilisateur à partir de la base de données
      ...
      <a href="update_profile.php" class="btn">modifier le profile</a> <!-- Lien vers la page de mise à jour du profil -->
      <a href="marque.php?logout=<?php echo $user_id; ?>" class="delete-btn">Quitter</a> <!-- Lien de déconnexion -->
